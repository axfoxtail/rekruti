...
@Component({
  selector: 'app-left-content-bar',
  templateUrl: './left-content-bar.component.html',
  styleUrls: ['./left-content-bar.component.css']
})
export class LeftContentBarComponent implements OnInit {
