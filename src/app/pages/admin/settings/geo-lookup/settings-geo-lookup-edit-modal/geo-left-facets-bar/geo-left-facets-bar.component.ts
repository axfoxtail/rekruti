...
@Component({
  selector: 'app-geo-left-facets-bar',
  templateUrl: './geo-left-facets-bar.component.html',
  styleUrls: ['./geo-left-facets-bar.component.css']
})
export class GeoLeftFacetsBarComponent implements OnInit {
  ...
  selectBucket(filterKey, bucket) {
    ...
    this.spinner.show();
    this.globalVar.urlFacets = this.urlFacets;
    this.globalVar.searchLinkToGeo({page: 0, urlFacets: this.urlFacets, sort: '', keyword: this.keyword == null ? '' : this.keyword});
  }
