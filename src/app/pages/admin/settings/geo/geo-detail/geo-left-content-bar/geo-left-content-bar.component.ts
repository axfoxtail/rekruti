...
@Component({
  selector: 'app-geo-left-content-bar',
  templateUrl: './geo-left-content-bar.component.html',
  styleUrls: ['./geo-left-content-bar.component.css']
})
export class GeoLeftContentBarComponent implements OnInit {
