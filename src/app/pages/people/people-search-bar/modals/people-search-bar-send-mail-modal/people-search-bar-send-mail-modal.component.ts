...
@Component({
  selector: 'app-people-search-bar-send-mail-modal',
  templateUrl: './people-search-bar-send-mail-modal.component.html',
  styleUrls: ['./people-search-bar-send-mail-modal.component.css']
})
export class PeopleSearchBarSendMailModalComponent implements OnInit {
